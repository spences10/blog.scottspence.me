...
So far, I love it, and would like to recommend it to others! (More on
that later though!) For now here's some of the Fathom marketing copy.
...
in the past and it gives the sort of information you'd expect.

> Want to track what users of your site are clicking and navigating
> to?

What you get with Fathom out of the box is the standard metrics like,
'Unique visits', 'Page views', 'Avg time on site' and 'Bounce rate'.
