...
have gone from using a template that I cloned and used happily for
this blog. The template was called Lumen and was just what I needed at
the time.
...
components in Markdown goodness, so you will be able to add your own
React components into your Markdown posts.
...
Add the components to the index file:
