...
If that ☝ makes no real sense (I've had to read it many, many times
myself), don't worry, now we're going to dig into that a bit more for
the creation of the code block component.
