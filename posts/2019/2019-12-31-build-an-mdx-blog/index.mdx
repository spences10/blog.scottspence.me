...
Gatsby uses the way you can compose React components for the layout,
meaning it's up to you how you want to layout what your building with
Gatsby. In this guide were going to initially greate a basic layout
component that we'll add to as we go along. For more detail on layout
components take a look at the Gatsby [layout components] page.
