...
Starting with the most basic "Hello World!" to adding deploying your
code to production.

## What you're going to build

You're going to build a developer blog with MDX support for some React
components in Markdown goodness, so you will be able to add React
components into your Markdown posts.
...
super awesome content you just created. So first up you need to create
a the `gatsby-config.js` file, in the terminal create the file:
